...
def typewriter_effect(text,speed=0.035):
    for char in text:
...
def intro_letter():
    ...
    typewriter_effect("That’s where you come in; I hear from a colleague of yours at Miskatonic University that you have an interest in particularly troublesome mysteries. So in exchange for you solving this mess, I’d like to offer you $200 and full room and board at the local hotel for as long as you need.")
